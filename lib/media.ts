...
/** Source of the dubbed video for a language, e.g. ".../x.mp4" -> ".../x.id.mp4".
 *  Each dubbed MP4 has a single audio track (that language), so the native
 *  player controls operate directly on it. Generated by scripts/mux-dubs.mjs. */
export function dubVideoSrc(src: string, lang: Language): string {

...
const CHAT_UI: Record<Language, Ui> = {
  ...
  ta: {
    greeting: (n) => `வணக்கம் — ${n} அவர்களுக்கான இன்றைய தகவல்களைப் பார்க்கிறேன். என்ன தெரிந்துகொள்ள விரும்புகிறீர்கள்?`,
    placeholder: (n) => `${n} அவர்களைப் பற்றிக் கேளுங்கள்…`,
    typing: "ORCA தட்டச்சு செய்கிறது…",
    listening: "கேட்கிறது…",
    transcribing: "எழுத்தாக்குகிறது…",
    readAloud: "சத்தமாக வாசி",
    voiceNote: "AI உதவியாளர் · குரல் AI-ஆல் உருவாக்கப்பட்டது",
    error: "மன்னிக்கவும், ஏதோ தவறு நடந்தது. மீண்டும் முயற்சிக்கவும்.",
    micError: "மைக்ரோஃபோனை அணுக முடியவில்லை.",
    offline: "இப்போது பதிலளிக்க முடியவில்லை — இணைய இணைப்பு தேவை. அவசரத் தகவலும் தொடர்புகளும் இணையம் இல்லாமலும் இயங்கும்.",
    prompts: {
      covid: ["நான் எதைக் கவனிக்க வேண்டும்?", "அவர் வெளியே செல்வது பாதுகாப்பானதா?", "சோதனைக் கருவியை எப்படிப் பயன்படுத்துவது?"],
      dengue: ["இன்றிரவு நான் எதைக் கவனிக்க வேண்டும்?", "அவருக்கு காய்ச்சல் வந்தால் என்ன செய்வது?", "கொசுக் கடியை எப்படிக் குறைப்பது?"],
    },
  },
};
